    ...
    <div id="input-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form class="p-4 md:p-5" action="{{ route('manajemen-infaq.store') }}" method="POST"
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex justify-center items-center">
                        <img src="https://via.placeholder.com/150" alt="Bukti Pembayaran"
                            class="w-full rounded-md max-w-[150px] h-full object-cover">
                    </div>
                    <div class="space-y-6">
                ...
                <table id="example" class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                    ...
                    <tbody>
                        @forelse ($infaqs as $infaq)
                            <tr>
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->nominal }}</td>
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->nama }}</td>
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->nomor }}</td>
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->metode }}</td>
                                @if ($infaq->bukti == null)
                                    <td class="px-6 py-4 text-gray-900">Tidak ada bukti</td>
                                @else
                                    <td class="px-6 py-4">
                                        <img src="{{ asset('images/' . $infaq->bukti) }}" alt="{{ $infaq->bukti }}"
                                            class="w-12 h-12 object-cover rounded">
                                    </td>
                                @endif
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->tanggal }}</td>
                                <td class="px-6 py-4 text-gray-900">{{ $infaq->jam }}</td>
                                <td class="px-6 py-4">
                                    <button class="text-white bg-blue-500 hover:bg-blue-900 mx-0 px-3 py-2 rounded-md"
                                        data-modal-target="detail-modal" data-modal-toggle="detail-modal">Detail</button>
                                    <button class="text-white bg-yellow-500 hover:bg-yellow-900 mx-0 px-3 py-2 rounded-md"
                                        data-modal-target="edit-modal" data-modal-toggle="edit-modal">Edit</button>
                                    <button class="text-white bg-red-500 hover:bg-red-900 mx-0 px-3 py-2 rounded-md"
